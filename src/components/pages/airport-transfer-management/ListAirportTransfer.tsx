...
import UpdateAirport from "./EditAndCreateAirport";
...
export const ListAirportTransfer: React.FC<Props> = ({
  data,
  isLoading,
  limit,
}) => {
  const [openUpdateDialog, setOpenUpdateDialog] = useState<boolean>(false);
  const [dataUpdate, setDataUpdate] = useState<AirportType | null>(null);
  ...
  const handleDelete = async (id: string) => {
    try {
      await airportTransferService.delete(id);
          ...
          <Table>
            <TableHeader className="bg-gray-100">
              <TableRow>
                ...
                <TableHead>Khu vực/địa điểm đón</TableHead>
